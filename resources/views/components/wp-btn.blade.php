...
<a href="https://wa.link/3l3jrh" target="_blank" type="button" class="mt-2 inline-flex items-center justify-center rounded-md border-2 border-transparent bg-blue-700 bg-none px-8 py-1 text-center text-sm font-bold text-white transition-all duration-200 ease-in-out focus:shadow hover:bg-gray-600">
