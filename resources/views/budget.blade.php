...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="antialiased bg-white dark:bg-gray-900">
        ...
        <section class="mb-32">
            ...
            <div class="relative overflow-hidden bg-no-repeat bg-cover" style="background-position: 50%; background-image: url('https://wallpapershome.com/images/pages/pic_h/225.jpg'); height: 300px;"></div>

            <div class="container text-gray-800 md:px-12 mx-auto">
                <div class="block rounded-lg shadow-lg py-8 md:py-12 px-2 md:px-6 bg-gray-300/40 dark:bg-gray-800/40 backdrop-blur-xl" style="margin-top: -100px;">
                    <div class="flex flex-wrap">
                        <div class="grow-0 shrink-0 basis-auto w-full xl:w-5/12 px-3 lg:px-6 mb-12 xl:mb-0">
                            <form method="POST" action="{{ url('/mail/buy') }}">
                                @csrf
                                ...
                                <div class="form-group mb-4 text-black dark:text-gray-500">
                                    <h4>@lang('page.buy-list')</h4>
                                </div>
                                <div class="form-group mb-6">
                                    <div class="w-full">
                                        <select name="products[]" id="multiSelection" data-te-select-init multiple multiple="multiple">
                                            @foreach ($prods as $p)
                            ...
                            <div class="flex flex-wrap">
                                <div class="mb-12 grow-0 shrink-0 basis-auto w-full md:w-6/12 px-3 lg:px-6">
                                    <div class="flex items-start">
                                        ...
                                        <div class="grow ml-6">
                                            <p class="font-bold mb-1 text-gray-800 dark:text-white">@lang('page.support')</p>
                                            <p class="text-gray-500">soporte@magnoplastic.com</p>
                                            <p class="text-gray-500">33 36 06 27 92</p>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="mb-12 grow-0 shrink-0 basis-auto w-full md:w-6/12 px-3 lg:px-6">
                                    <div class="flex items-start">
                                        ...
                                        <div class="grow ml-6">
                                            <p class="font-bold mb-1 text-gray-800 dark:text-white">@lang('page.sales')</p>
                                            <p class="text-gray-500">ventas@magnoplastic.com</p>
                                            {{-- <p class="text-gray-500">33 00 00 00 00</p> --}}
                                            @include('components.wp-btn')
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="mb-12 md:mb-0 grow-0 shrink-0 basis-auto w-full md:w-6/12 px-3 lg:px-6">
                                    <div class="flex align-start">
                                        ...
                                        <div class="grow ml-6">
                                            <p class="font-bold mb-1 text-gray-800 dark:text-white">@lang('page.info')</p>
                                            <p class="text-gray-500">info@magnoplastic.com</p>
                                            <p class="text-gray-500">33 33 36 94 84</p>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="grow-0 shrink-0 basis-auto w-full md:w-6/12 px-3 lg:px-6">
                                    <div class="flex align-start">
                                        ...
                                        <div class="grow ml-6">
                                            <p class="font-bold mb-1 text-gray-800 dark:text-white">@lang('page.bugs')</p>
                                            <p class="text-gray-500">master@magnoplastic.com</p>
    ...
    @vite(['resources/js/UIMode.js','resources/js/app.js'])
</html>
