        ...
        <table class="es-wrapper" width="100%" cellspacing="0" cellpadding="0">
            <tr>
                <td valign="top">
                                                            ...
                                                            <tr>
                                                                <td align="left" class="es-m-txt-c" style="font-size: 0px">
                                                                    <a target="_blank" href="https://magnoplastic.com">
                                                                        <img src="https://mknnhk.stripocdn.email/content/guids/CABINET_211922a799f601d694096a13e9c85a275db6243650cfcc4c77eb8e0d57797636/images/masterlogowhite.png" alt="Confirm email" style="display: block;border-radius: 100px" width="100" title="Confirm email" height="66">
                                                                    </a>
                                                                </td>
                                                            </tr>
                                                        </table>
                                                        ...
                                                        <table cellpadding="0" cellspacing="0" width="100%" bgcolor="#fafafa" style="background-color: #fafafa;border-radius: 10px;border-collapse: separate" role="presentation">
                                                            <tr>
                                                                <td align="left" class="es-p20">
                                                                    <h3>Hola de nuevo!</h3>
                                                                    <p><br></p>
                                                                    <p>Un cliente necesita&nbsp;una nueva cotización de productos, así que aquí están sus datos.</p>
                                                                    <p><br></p>
                                                                    <p>Nombre:</p>
                                                                    {{ $name }}
                                                                    <p><br></p>
                                                                    ...
                                                                    {{ $phone }}
                                                                    <p><br></p>
                                                                    <p>Productos que le interesan:</p>
                                                                    {{ $prods }}
                                                                    <p><br></p>
                    ...
                    <table cellpadding="0" cellspacing="0" class="es-content" align="center"><tr><td align="center"><table bgcolor="#efefef" class="es-content-body" align="center" cellpadding="0" cellspacing="0" width="600"><tr><td class="es-p40r es-p40l" align="left"><table cellpadding="0" cellspacing="0" width="100%"><tr><td width="520" align="center" valign="top"><table cellpadding="0" cellspacing="0" width="100%" role="presentation"><tr><td align="left"><p>Atentamente,<br><br>El servicio de contacto de Magnoplastic</p></td></tr><tr><td align="center" class="es-p40t es-p20b" style="font-size:0"><table border="0" width="100%" cellpadding="0" cellspacing="0" role="presentation"><tr><td style="border-bottom: 1px solid #666666;background: unset;height: 1px;width: 100%;margin: 0px"></td></tr></table></td></tr></table></td></tr></table></td></tr></table></td>
