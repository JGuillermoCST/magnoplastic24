...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <section class="mb-32">
        ...
        <div class="relative overflow-hidden bg-no-repeat bg-cover" style="background-position: 50%; background-image: url('https://wallpapercave.com/wp/wp7121535.jpg'); height: 300px;"></div>

        <div class="container text-gray-800 md:px-12 mx-auto">
            <div class="block rounded-lg shadow-lg py-10 md:py-12 px-2 md:px-6 bg-gray-300/40 dark:bg-gray-800/40 backdrop-blur-xl" style="margin-top: -100px;">
                <div class="flex flex-wrap">
                    <div class="grow-0 shrink-0 basis-auto w-full xl:w-5/12 px-3 lg:px-6 mb-12 xl:mb-0">
                        <form method="POST" action="{{ url('/mail/sell') }}">
                            @csrf
